    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f8f9f5] py-16">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">About Organizon Organics</h1>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Purity</h3>
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">People</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Planet</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">From Farm to Your Family</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-[#2d5016] text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                1
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Partner Farms</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Careful Packaging</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Delivered Fresh</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="bg-[#f8f9f5] py-16">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Certified & Trusted</h2>
          ...
          <div className="flex flex-wrap justify-center gap-8 items-center">
            <div className="bg-white rounded-lg p-6 shadow-md">
              <p className="text-sm font-semibold text-gray-700 mb-2">FSSAI Licensed</p>
              <p className="text-xs text-gray-500">License No: XXXXXXXXXXXXXX</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <p className="text-sm font-semibold text-gray-700 mb-2">Organic Certified</p>
              <p className="text-xs text-gray-500">India Organic</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <p className="text-sm font-semibold text-gray-700 mb-2">ISO Certified</p>
      ...
      <section className="py-16">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Join the Organic Movement</h2>
