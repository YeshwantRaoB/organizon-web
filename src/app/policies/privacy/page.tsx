          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed">
                At Organizon Organics, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you use our website and services.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 leading-relaxed">
                <li><strong>Service Providers:</strong> Payment processors, shipping partners, and technology providers</li>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                We use cookies to enhance your browsing experience, analyze site traffic, and personalize content. You can control cookies through your browser settings, but disabling them may affect site functionality.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                We may update this Privacy Policy from time to time. We&apos;ll notify you of significant changes via email or website notice. Continued use of our services constitutes acceptance of the updated policy.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-4 space-y-2">
                <li><strong>Email:</strong> privacy@organizon.in</li>
